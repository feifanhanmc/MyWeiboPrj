...
if __name__ == '__main__':
    ...
    #     u.get_user_data()
#     print u.client.access_token
#     access_token = '2.00lVXkMEAyfVoB99a5ffec2epwLmqB'
#     APP_KEY = '1662499124'
#     APP_SECRET = '2e2813ca656f7e5e802af260f22f97d0'  
#     CALLBACK_URL = 'https://api.weibo.com/oauth2/default.html'
#     client = APIClient(app_key = APP_KEY, app_secret = APP_SECRET, redirect_uri = CALLBACK_URL)
#     print client.users.show.get(access_token = access_token, uid = 3852939269)